    ...
    <RequireAuth>
        <nav className="fixed top-0 left-0 h-full w-auto bg-gray-800 text-white p-6 flex flex-col gap-4 shadow-lg">
          <div className="flex flex-col flex-grow gap-4">
            <Link href="/trafficviolation" className="p-4 hover:bg-gray-700 rounded-lg flex gap-4 items-center">
              <FaCarCrash size={30}/>
              <span>Traffic Violations</span>
            </Link>
            {user?.role !== "Officer" && (
              <Link href="/manage_users" className="p-4 hover:bg-gray-700 rounded-lg flex gap-4 items-center">
                <FaUser size={30}/>
